$(document).ready(function(){
            $("#sendAjax").click(function(){ // при нажатии кнопки добавления новой статьи
                ...
                $.ajax({ // описываем наш запрос
                        ...
                        data: "first_name="+first_name+"&last_name="+last_name+"&email="+email+"&adress="+adress+"&city="+city+"&country="+country, // передаем данные из формы
                        success: function(response) { // когда получаем ответ
                            ...
                            if (response.code == 'success') // если вернулся статус успешного добавления данных в БД
                            {
                                $("#table").load('/ajax/getarticles'); // обновляем таблицу
                            }
